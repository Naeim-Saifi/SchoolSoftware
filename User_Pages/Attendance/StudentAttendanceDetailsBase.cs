...
{
    public class StudentAttendanceDetailsBase : ComponentBase
    {
        [Inject]
        ...
        public List<StudentAttendanceList_UserIDWise> _studentAttendanceList = new List<StudentAttendanceList_UserIDWise>();
        public SfGrid<StudentAttendanceList_UserIDWise> sfgridUserIDWise;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                AttendanceInputParaModel attendanceInputParaModel = new AttendanceInputParaModel()
                {
                    ...
                    reportType = AttendanceReportType.AttendanceList_UserWise
                };
                _studentAttendanceList = (await _attendanceService.StudentAttendanceList_UserIDWise(attendanceInputParaModel)).ToList();
            }
