...
namespace AdminDashboard.Server.User_Pages.Inventory.ItemInvoiceGenerate
{
    public class ItemInvoiceGenerateBase : ComponentBase
    {
        ...
        public ItemInvoiceGenerateViewModel itemInvoiceGenerateViewModel = new ItemInvoiceGenerateViewModel();
        public List<ItemInvoiceGenerateListModel> _ItemInvoiceGenerateListModel = new List<ItemInvoiceGenerateListModel>();
        public ItemInvoiceGenerateApiModel itemInvoiceGenerateApiModel { get; set; }


        public SfGrid<ItemInvoiceGenerateListModel> sfInvoiceGenerateOutPutDetails;
        ...
        public List<string> EnquirytoolBarItems = (new List<string>() { "Add Invoice", "Print", "ExportExcel", "Collapse All", "Expand All", "Search" });
        ...
        public async Task AddBillItems()
        {
            ...
            _ItemInvoiceGenerateListModel.Add(new ItemInvoiceGenerateListModel()
            {
                //vendorId = Convert.ToInt32(ItemInvoiceGenerateViewModel.vendorId),
            ...
            sfInvoiceGenerateOutPutDetails.Refresh();
            StateHasChanged();
            //billItemviewModel.ItemName=string.Empty;
            //billItemviewModel.Quantity = 0;
            //billItemviewModel.PurchaseRate = 0;
        ...
        public void RowBound(RowDataBoundEventArgs<ItemInvoiceGenerateListModel> Args)
        {
        ...
        public void EditOrderItemDetail(CommandClickEventArgs<ItemInvoiceGenerateListModel> args)
        {
            ...
            if (buttcontext == "Edit")
            {
                ...
                // ddEnable = false;
                itemInvoiceGenerateViewModel = new ItemInvoiceGenerateViewModel()
                {
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            if (args.Item.Text == "Add Invoice")
            {
                ...
                DialogHeaderName = "Add Invoice Details";
                OperationType = "Add";
            ...
            {
                this.sfInvoiceGenerateOutPutDetails.ExportToExcelAsync();
            }
            else if (args.Item.Text == "Collapse All")
            {
                this.sfInvoiceGenerateOutPutDetails.CollapseAllGroupAsync();
            }
            else if (args.Item.Text == "Expand All")
            {
                this.sfInvoiceGenerateOutPutDetails.ExpandAllGroupAsync();
            }
        }
        ...
        public async void OnValidSubmit(EditContext contex)
        {
            ...
            if (isValid)
            {
                itemInvoiceGenerateApiModel = new ItemInvoiceGenerateApiModel()
                {
                ...
                {
                    itemInvoiceGenerateApiModel.OperationType = OperationAction.Add;
                }
                else if (OperationType == "Update")
                {
                    itemInvoiceGenerateApiModel.OperationType = OperationAction.Update;
                }
                //Delete Operation
                else
                {
                    itemInvoiceGenerateApiModel.OperationType = OperationAction.Delete;
                }

                SaveEnquiryDetails(itemInvoiceGenerateApiModel);
        ...
        private async void SaveEnquiryDetails(ItemInvoiceGenerateApiModel itemInvoiceGenerateApiModel)
        {
            try
            {
                if (itemInvoiceGenerateApiModel.OperationType != "NA")
                {
                    ...
                    if (aPIReturnModel.status == false)
                    {
                        ...
                        ItemInvoiceGenerateParaModel itemInvoiceGenerateParaModel = new ItemInvoiceGenerateParaModel()
                        {
                            financialYear = _sessionModel.FinancialYear,
                            schoolCode = _sessionModel.SchoolCode,
                            InvoiceGnereateId = 0,
                        ...
                        //   _ItemMasterListMoel  = (await enquiryService.GET_EnquiryDetails_List(itemInvoiceGenerateParaModel)).ToList();
