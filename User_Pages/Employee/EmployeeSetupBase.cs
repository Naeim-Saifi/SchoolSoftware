...
namespace AdminDashboard.Server.User_Pages.EmployeeSetup
{
    public class EmployeeSetupBase: ComponentBase
    {
        ...
        public List<string> toolBarItems = (new List<string>() { "Add User", "Add Role", "Print", "ExportExcel", "Collapse All", "Expand All", "Search", "ColumnChooser" });
