...
namespace AdminDashboard.Server.User_Pages.Syllabus
{
    ...
    public class SyllabusStatusBase : ComponentBase
    {
        [Inject]
        ...
        public List<SyllabusStatus_Output_Model> _syllabusStatusList = new List<SyllabusStatus_Output_Model>();
       
        //data binding for blazor page
        public SyllabusStatusViewModel  syllabusStatusViewModel = new SyllabusStatusViewModel();
        ...
        public SfGrid<SyllabusStatus_Output_Model> sfSyllabusStatusGrid;

        public List<string> toolBarItems = (new List<string>() { "Add Syllabus Status", "ExcelExport", "Collapse All", "Expand All", "Print", "Search" });
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            SyllabusStatus_Input_Para_Model syllabusStatus_Input_Para_Model = new SyllabusStatus_Input_Para_Model()
            {
                classId = 0,
                sectionId=0,
                subjectId = 0,
            ...
            //_syllabusStatusList = (await syllabusService.Get_SyllabusStatus_List(syllabusStatus_Input_Para_Model)).ToList();

              _statusList = new List<SyllabusStatus>() {
                new SyllabusStatus() { Id = 1,  Text = "Start"},
                new SyllabusStatus() { Id = 2,  Text = "Revision"},
                new SyllabusStatus() { Id = 3,  Text = "Complted"},
        ...
        {
            if (args.Item.Text == "Add Syllabus Status")
            {
                ...
                OperationType = "Add";
                HeaderText = "Add Syllabus Status";
                ddEnable = true;
            ...
            {
                this.sfSyllabusStatusGrid.CollapseAllGroupAsync();
            }
            else if (args.Item.Text == "Expand All")
            {
                this.sfSyllabusStatusGrid.ExpandAllGroupAsync();
            }
            ...
            {
                new ExcelCell() { RowSpan= 2,ColSpan=6 , Value= " Syllabus Status Details", Style = new ExcelStyle() {  Bold = true, FontSize = 13, Italic= false, HAlign=ExcelHorizontalAlign.Center  }  }
            };
                ...
                List<ExcelRow> HeaderContent = new List<ExcelRow>
            {
                ...
                ExcelProperties.FileName = "SyllabusStatus.xlsx";
                this.sfSyllabusStatusGrid.ExcelExport(ExcelProperties);
            }
        }
        public void EditSyllabusStatusMaster(CommandClickEventArgs<SyllabusStatus_Output_Model> args)
        {
