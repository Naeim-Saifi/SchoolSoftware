...
namespace AdminDashboard.Server.Pages.StudentModule.ViewTimeTable
{
    public class ViewTimeTableBase : ComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            timeTableListModels = (await _itimetableService.GetTimeTableList(_sessionModel.SchoolCode, _sessionModel.FinancialYear, _sessionModel.UserId, "StudentTimeTable")).ToList();
